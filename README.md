...
# 1. Download & execute from GitHub in one line/n
# 2 goto qwen mcp then my mcp then add this http://127.0.0.1:18850/ to url and make sure its set as streamablehttp
